      ...
      <div>
          ...
          <div className='flex gap-6 items-center'>
            <div className='text-[16px] py-8 text-white cursor-pointer'>
              <a href='https://www.instagram.com/ai.gpt.gallery/' target='_blank'>
                <Image width={22} height={22} src='/././instagram.png' alt='instagram logo' />
              </a>
            </div>
            <div className='text-[16px] py-8 text-white cursor-pointer'>
              <a href='https://www.tiktok.com/@ai.gpt.gallery/' target='_blank'>
                <Image width={38} height={38} src='/././tiktok.png' alt='tiktok logo' />
              </a>
            </div>
          </div>
      </div>
        ...
        <div className='flex items-center justify-between font-thin block md:hidden'>
          ...
          <div className='flex gap-4 items-center'>
            <div className='text-[16px] py-8 text-white cursor-pointer'>
              <a href='https://www.instagram.com/ai.gpt.gallery/' target='_blank'>
                <Image width={18} height={18} src='/././instagram.png' alt='instagram logo' />
              </a>
            </div>
            <div className='text-[16px] py-8 text-white cursor-pointer'>
              <a href='https://www.tiktok.com/@ai.gpt.gallery/' target='_blank'>
                <Image width={32} height={32} src='/././tiktok.png' alt='tiktok logo' />
              </a>
            </div>
          </div>
        </div>
