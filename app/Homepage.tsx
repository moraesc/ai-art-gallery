...
export const Homepage = () => {
  return (
    <div className='relative flex flex-col justify-center h-[100vh] items-center'>
      ...
      <div className='grid grid-cols-8 gap-2 mt-8'>
          {SAMPLE_IMAGES.map((image, index) => (
              <div className='relative group' key={index}>
                <div className='absolute top-0 left-0 bg-[rgba(0,0,0,0.6)] z-2 w-full h-full group-hover:hidden'></div>
                <Image
                  key={index}
                  width={64}
                  height={64}
      ...
      <p className="shimmer mt-4 text-[20px] text-white"><a href='/gallery'>Enter Gallery</a></p>
    </div>
  )
}
