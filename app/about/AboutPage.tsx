...
export const AboutPage = () => {
    return (
      <div className='relative flex flex-col lg:flex-row justify-center items-center mt-48'>
        <div className='flex flex-col justify-between items-center'>
          ...
          <p className='text-white text-[20px] md:text-[20px] w-full px-2 md:w-[520px] font-[Open Sans] font-thin mt-8'>
          ...
          <p className='shimmer text-[16px] w-full px-2 md:w-[520px] font-[Open Sans] font-thin mt-12 text-[#c8fdff]'>
